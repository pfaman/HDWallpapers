...
public class CarActivity extends AppCompatActivity {
    ...
    public void fetchWallpaper() {
        ...
        String url = "https://pixabay.com/api/?key=22301803-79762318050f3ddfca57eff66&q=car&image_type=photo&pretty=true&page=" + pageNumber + "&per_page=80";
    ...
    public void onShare(MenuItem item) {
        ...
        Toast.makeText(this, "data has been Sent sussss", Toast.LENGTH_SHORT).show();
